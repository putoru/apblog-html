...
function showHeaderOption(){
    ...
    s += "<table>";
    s += "<tr>";
    s += "<td style='text-align:right'>Urut berdasarkan: ";
    s += "<td><select onchange='sortBy(this.value.substr(1), this.value.substr(0,1))'>";
    s += "<option value='0published'/>Tanggal dipublikasikan";
    s += "<option value='1title'/>Judul";
    s += "</select>";
    s += "<tr>";
    s += "<td style='text-align:right'>Lihat yang berlabel: ";
    ...
    s += "</select>";
    s += "<tr>";
    s += "<td><td><a href='javascript:showPostsWLabel(\"*\");'>Lihat semua</a>";
    s += "</table>";
